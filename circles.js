...
lib.ssMetadata = [
		{name:"circles_atlas_", frames: [[0,344,278,88],[676,320,314,92],[344,332,310,88],[0,0,342,342],[344,0,330,330],[676,0,318,318]]}
];
...
(lib.CachedBmp_802 = function() {
	this.initialize(ss["circles_atlas_"]);
	this.gotoAndStop(0);
...
p.nominalBounds = new cjs.Rectangle(294.1,249,193.89999999999998,60.10000000000002);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/circles_atlas_.png", id:"circles_atlas_"}
	],
	preloads: []
};
