...
lib.ssMetadata = [
		{name:"circlesV03_atlas_", frames: [[0,986,278,88],[0,802,314,92],[0,896,310,88],[1102,0,342,342],[1102,344,330,330],[1102,676,318,318],[0,0,1100,800]]}
];
...
(lib.CachedBmp_7 = function() {
	this.initialize(ss["circlesV03_atlas_"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.circlesV03 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/circlesV03_atlas_.png", id:"circlesV03_atlas_"}
	],
	preloads: []
};
